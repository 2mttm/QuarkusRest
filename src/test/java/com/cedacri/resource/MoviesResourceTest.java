...
class MoviesResourceTest {
    ...
    @Test
    @DisplayName("serviciul extern intoarece acelasi raspuns pentru orice chemare")
    ...
    @Test
    @DisplayName("serviciul extern intoarce raspusnuri in functie de valoarea la parametri")
    ...
    @Test
    @DisplayName("serviciul extern semnaleaza o careva eroare")
    ...
    @Test
    @DisplayName("serviciul extern intoarce lista de valori definite in clasa SomeExternalService, cu exceptia la un test, unde se va crea un mock")
    ...
    @Test
    @DisplayName("serviciul extern intoarce raspunsuri diferite pentru chemari consecutive")
